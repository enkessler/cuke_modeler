...
describe 'Feature, Integration' do
  ...
  describe 'unique behavior' do
    ...
    it 'stores the original data generated by the parsing adapter', :gherkin4 => true do
      ...
      raw_data = feature.parsing_data

      expect(raw_data.keys).to match_array([:type, :tags, :location, :language, :keyword, :name, :children, :description])
    ...
    it 'stores the original data generated by the parsing adapter', :gherkin3 => true do
      ...
      expect(raw_data.keys).to match_array([:type, :tags, :location, :language, :keyword, :name, :scenarioDefinitions, :comments, :background, :description])
      expect(raw_data[:type]).to eq(:Feature)
    end
