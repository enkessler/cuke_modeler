  ...
  describe 'unique behavior' do
    ...
    describe 'parsing data' do
      ...
      context 'with minimum viable Gherkin' do
        ...
        it 'stores the original data generated by the parsing adapter', :if => gherkin?(9) do
      ...
      context 'with maximum viable Gherkin' do
        ...
        context 'that has a table' do
          ...
          it 'stores the original data generated by the parsing adapter (with a table)', :if => gherkin?(9) do
            step = clazz.new(source_text)
            data = step.parsing_data
        ...
        context 'that has a doc string' do
          ...
          it 'stores the original data generated by the parsing adapter (with a doc string)', :if => gherkin?(9) do
            step = clazz.new(source_text)
            data = step.parsing_data
