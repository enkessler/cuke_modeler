...
describe 'Step, Integration' do
  ...
  describe 'unique behavior' do
    ...
    describe 'parsing data' do
      ...
      it 'stores the original data generated by the parsing adapter (with a table)', :gherkin7 => true do
      ...
      it 'stores the original data generated by the parsing adapter (with a doc string)', :gherkin7 => true do
        step = clazz.new("#{STEP_KEYWORD} test step\n\"\"\"\na doc string\n\"\"\"")
        data = step.parsing_data
