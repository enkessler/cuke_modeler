  ...
  describe 'unique behavior' do
    ...
    describe 'parsing data' do
      ...
      context 'with minimum viable Gherkin' do
        ...
        it 'stores the original data generated by the parsing adapter', if: gherkin?((20..MOST_CURRENT_GHERKIN_VERSION)) do
      ...
      context 'with maximum viable Gherkin' do
        ...
        context 'that has a table' do
          ...
          it 'stores the original data generated by the parsing adapter (with a table)', if: gherkin?((20..MOST_CURRENT_GHERKIN_VERSION)) do
            step = clazz.new(source_text)
            data = step.parsing_data
        ...
        context 'that has a doc string' do
          ...
          it 'stores the original data generated by the parsing adapter (with a doc string)', if: gherkin?((20..MOST_CURRENT_GHERKIN_VERSION)) do
            step = clazz.new(source_text)
            data = step.parsing_data
