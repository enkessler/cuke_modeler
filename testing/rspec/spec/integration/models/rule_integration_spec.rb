...
RSpec.describe 'Rule, Integration' do
  ...
  describe 'unique behavior' do
    ...
    it 'properly sets its child models', if: gherkin?(18) do
      source = "@a_tag
    ...
    it 'properly sets its child models', if: gherkin?(9, 10, 11, 12, 13, 14, 15, 16, 17) do
    ...
    describe 'parsing data' do
      ...
      context 'with minimum viable Gherkin' do
        ...
        it 'stores the original data generated by the parsing adapter', if: gherkin?(13, 14, 15, 16, 17, 18) do
      ...
      context 'with maximum viable Gherkin' do
        ...
        it 'stores the original data generated by the parsing adapter', if: gherkin?(18) do
          rule = clazz.new(source_text)
          data = rule.parsing_data
        ...
        it 'stores the original data generated by the parsing adapter', if: gherkin?(13, 14, 15, 16, 17) do
          rule = clazz.new(source_text)
          data = rule.parsing_data
    ...
    describe 'model population' do
      ...
      context 'from source text' do
        ...
        context 'a filled rule' do
          ...
          it "models the rules's tags", if: gherkin?(18) do
    ...
    describe 'rule output' do
      ...
      context 'from source text' do
        ...
        it 'can output a rule that has tags', if: gherkin?(18) do
          source = ['@tag1 @tag2',
                    '@tag3',
                    "#{RULE_KEYWORD}:"]
          source = source.join("\n")
