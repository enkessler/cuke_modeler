...
RSpec.describe 'Rule, Integration' do
  ...
  describe 'unique behavior' do
    ...
    it 'properly sets its child models', if: gherkin?(18, 19) do
      source = "@a_tag
    ...
    describe 'model population' do
      ...
      context 'from source text' do
        ...
        context 'a filled rule' do
          ...
          it "models the rules's tags", if: gherkin?(18, 19) do
    ...
    describe 'rule output' do
      ...
      context 'from source text' do
        ...
        it 'can output a rule that has tags', if: gherkin?(18, 19) do
          source = ['@tag1 @tag2',
                    '@tag3',
                    "#{RULE_KEYWORD}:"]
          source = source.join("\n")
