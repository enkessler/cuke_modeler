...
describe 'Example, Integration' do
  ...
  describe 'unique behavior' do
    ...
    it 'can be instantiated with the minimum viable Gherkin', :if => gherkin?(4, 5, 6, 7) do
    ...
    describe 'model population' do
      ...
      context 'from source text' do
        ...
        it "models the example's keyword", :if => gherkin?(4, 5, 6, 7) do
        ...
        # gherkin 2.x/3.x does not accept incomplete examples
        context 'an empty example', :if => gherkin?(4, 5, 6, 7) do
    ...
    describe 'example output' do
      ...
      context 'from source text' do
        ...
        # gherkin 2.x/3.x does not accept incomplete examples
        it 'can output an empty example', :if => gherkin?(4, 5, 6, 7) do
          source = ["#{EXAMPLE_KEYWORD}:"]
          source = source.join("\n")
          example = clazz.new(source)
        ...
        # gherkin 2.x/3.x does not accept incomplete examples
        it 'can output an example that has a name', :if => gherkin?(4, 5, 6, 7) do
        ...
        # gherkin 2.x/3.x does not accept incomplete examples
        it 'can output an example that has a description', :if => gherkin?(4, 5, 6, 7) do
          source = ["#{EXAMPLE_KEYWORD}:",
                    'Some description.',
                    'Some more description.']
          source = source.join("\n")
        ...
        it 'can output an example that has a single row', :if => gherkin?(2, 4, 5, 6, 7) do
          source = ["#{EXAMPLE_KEYWORD}:",
                    '|param1|param2|']
          source = source.join("\n")
          example = clazz.new(source)
