...
describe 'Outline, Integration' do
  ...
  describe 'unique behavior' do
    ...
    it 'can be instantiated with the minimum viable Gherkin', :if => gherkin?(2, 4, 5, 6, 7) do
    ...
    describe 'model population' do
      ...
      context 'from source text' do
        ...
        # gherkin 3.x does not accept incomplete outlines
        it "models the outline's keyword", :if => gherkin?(2, 4, 5, 6, 7) do
        ...
        # gherkin 3.x does not accept incomplete outlines
        context 'an empty outline', :if => gherkin?(2, 4, 5, 6, 7) do
    ...
    describe 'outline output' do
      ...
      context 'from source text' do
        ...
        # gherkin 3.x does not accept incomplete outlines
        it 'can output an empty outline', :if => gherkin?(2, 4, 5, 6, 7) do
          source = ["#{OUTLINE_KEYWORD}:"]
          source = source.join("\n")
          outline = clazz.new(source)
        ...
        # gherkin 3.x does not accept incomplete outlines
        it 'can output a outline that has a name', :if => gherkin?(2, 4, 5, 6, 7) do
        ...
        # gherkin 3.x does not accept incomplete outlines
        it 'can output a outline that has a description', :if => gherkin?(2, 4, 5, 6, 7) do
          source = ["#{OUTLINE_KEYWORD}:",
                    'Some description.',
                    'Some more description.']
          source = source.join("\n")
        ...
        # gherkin 3.x does not accept incomplete outlines
        it 'can output a outline that has steps', :if => gherkin?(2, 4, 5, 6, 7) do
          source = ["#{OUTLINE_KEYWORD}:",
                    "  #{STEP_KEYWORD} a step",
                    '    | value |',
        ...
        # gherkin 3.x does not accept incomplete outlines
        it 'can output a outline that has tags', :if => gherkin?(2, 4, 5, 6, 7) do
          source = ['@tag1 @tag2',
                    '@tag3',
                    "#{OUTLINE_KEYWORD}:"]
          source = source.join("\n")
