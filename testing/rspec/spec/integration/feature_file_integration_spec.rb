...
describe 'FeatureFile, Integration' do
  ...
  describe 'unique behavior' do
    ...
    it 'stores the original data generated by the parsing adapter', :gherkin4 => true do
      test_file = Tempfile.new(['test_file', '.feature'])
    ...
    it 'provides its own filename when being parsed' do
      test_file = Tempfile.new(['test_file', '.feature'])
      File.open(test_file.path, 'w') { |file| file.write('bad feature text') }
    ...
    describe 'model population' do
      ...
      let(:feature_file_path) { Tempfile.new(['test_file', '.feature']).path }
    ...
    it 'properly sets its child models' do
      file_path = Tempfile.new(['test_file', '.feature']).path
    ...
    describe 'getting ancestors' do
      ...
      let(:feature_file_path) { Tempfile.new(['feature_file_test_file', '.feature'], directory_path).path }
    ...
    describe 'feature file output' do
      ...
      context 'from source text' do
        ...
        let(:source_text) { "#{@feature_keyword}: Test feature" }
        let(:feature_file_path) { Tempfile.new(['feature_file_test_file', '.feature']).path }
        let(:feature_file) { clazz.new(feature_file_path) }
      ...
      it 'can be remade from its own output' do
        path = Tempfile.new(['feature_file_test_file', '.feature']).path
        File.open(path, "w") { |file| file.write "#{@feature_keyword}:" }
