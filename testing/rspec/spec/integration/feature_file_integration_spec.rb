...
describe 'FeatureFile, Integration' do
  ...
  describe 'unique behavior' do
    ...
    it 'stores the original data generated by the parsing adapter', :gherkin4 => true do
      test_file = CukeModeler::FileHelper.create_feature_file("#{@feature_keyword}: test feature", 'test_file')

      feature_file = clazz.new(test_file.path)
    ...
    it 'provides its own filename when being parsed' do
      test_file = CukeModeler::FileHelper.create_feature_file('bad feature text', 'test_file')

      expect { clazz.new(test_file.path) }.to raise_error(/'#{test_file.path}'/)
    end

    it 'cannot model a non-existent feature file' do
      path = "#{Dir.mktmpdir}/missing_file.feature"
    ...
    describe 'model population' do
      ...
      let(:feature_file_path) { CukeModeler::FileHelper.create_feature_file.path }
    ...
    it 'properly sets its child models' do
      file_path = CukeModeler::FileHelper.create_feature_file("#{@feature_keyword}: Test feature", 'test_file').path
    ...
    describe 'getting ancestors' do
      ...
      let(:feature_file_path) { CukeModeler::FileHelper.create_feature_file('', 'feature_file_test_file', directory_path).path }
    ...
    describe 'feature file output' do
      ...
      context 'from source text' do
        ...
        let(:source_text) { "#{@feature_keyword}: Test feature" }
        let(:feature_file_path) { CukeModeler::FileHelper.create_feature_file('', 'feature_file_test_file').path }
        let(:feature_file) { clazz.new(feature_file_path) }
      ...
      it 'can be remade from its own output' do
        path = CukeModeler::FileHelper.create_feature_file("#{@feature_keyword}:", 'feature_file_test_file').path
